...
const CryptoNote::CachedTransaction &CryptoNote::PendingTransactionInfo::transaction() const {
...
CryptoNote::PosixTimestamp CryptoNote::PendingTransactionInfo::receiveTime() const {
