...
Open the wallets with xi-pgservice like so:

./xi-pgservice -w Wallet1.wallet -p walletpass1 --rpc-password test --bind-port 31019
./xi-pgservice -w Wallet1.wallet -p walletpass1 --rpc-password test --bind-port 31020
...
moveDecimal = 10000  # Xi has 4 decimals so 10000 is the divide/multiply factor
...
anonymity = 3
fee = 10 # atomic units, Xi would be 0.10 as the tx network fee
