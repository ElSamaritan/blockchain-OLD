...
#define CORE_RPC_ERROR_CODE_BLOCK_EXPLORER_DISABLED -11
#define CORE_RPC_ERROR_CODE_BLOCK_EXPLORER_ONLY -12
#define CORE_RPC_ERROR_CODE_NOT_FOUND -13
#define CORE_RPC_ERROR_CODE_MINER_EDNPOINT_DISABLED -14
