...
void CLIMinerBenchmark::serialize_cpu_features(const cpu_features::X86Features &features,
...
void CLIMinerBenchmark::serialize_cpu_info(const cpu_features::X86Info &info, CryptoNote::ISerializer &serializer) {
...
void CLIMinerBenchmark::serialize_benchmark_result(const CLIMinerBenchmark::BenchmarkResult &result,
                                                   CryptoNote::ISerializer &serializer) {
...
void CLIMinerBenchmark::serialize_benchmark_summary(const CLIMinerBenchmark::BencharkSummary &summary,
                                                    CryptoNote::ISerializer &serializer) {
