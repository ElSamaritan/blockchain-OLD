 ...
 *
 * This source is altered from its original https://github.com/ReneNyffenegger/cpp-base64/blob/master/base64.cpp. We
...
std::string Xi::Base64::encode(const std::string &raw) {
  std::string ret;
  unsigned char const *bytes_to_encode = reinterpret_cast<unsigned char const *>(raw.c_str());
...
std::string Xi::Base64::decode(const std::string &encoded_string) {
