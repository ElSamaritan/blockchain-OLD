...
static void gcomp_select(ge_precomp *t, int pos, signed char b) {
  ge_precomp minust;
  unsigned char bnegative = negative(b);
  unsigned char babs = (unsigned char)(b - (((-bnegative) & b) << 1));

  ge_precomp_0(t);
  ge_precomp_cmov(t, &ge_base[pos][0], equal((signed char)babs, 1));
  ge_precomp_cmov(t, &ge_base[pos][1], equal((signed char)babs, 2));
  ge_precomp_cmov(t, &ge_base[pos][2], equal((signed char)babs, 3));
  ge_precomp_cmov(t, &ge_base[pos][3], equal((signed char)babs, 4));
  ge_precomp_cmov(t, &ge_base[pos][4], equal((signed char)babs, 5));
  ge_precomp_cmov(t, &ge_base[pos][5], equal((signed char)babs, 6));
  ge_precomp_cmov(t, &ge_base[pos][6], equal((signed char)babs, 7));
  ge_precomp_cmov(t, &ge_base[pos][7], equal((signed char)babs, 8));
...
void ge_scalarmult(ge_p2 *r, const unsigned char *a, const ge_p3 *A) {
  ...
  for (i = 63; i >= 0; i--) {
    ...
    ge_p1p1_to_p3(&u, &t);
    ge_cached_0(&cur);
    ge_cached_cmov(&cur, &Ai[0], (unsigned char)equal(babs, 1));
    ge_cached_cmov(&cur, &Ai[1], (unsigned char)equal(babs, 2));
    ge_cached_cmov(&cur, &Ai[2], (unsigned char)equal(babs, 3));
    ge_cached_cmov(&cur, &Ai[3], (unsigned char)equal(babs, 4));
    ge_cached_cmov(&cur, &Ai[4], (unsigned char)equal(babs, 5));
    ge_cached_cmov(&cur, &Ai[5], (unsigned char)equal(babs, 6));
    ge_cached_cmov(&cur, &Ai[6], (unsigned char)equal(babs, 7));
    ge_cached_cmov(&cur, &Ai[7], (unsigned char)equal(babs, 8));
...
void ge_fromfe_frombytes_vartime(ge_p2 *r, const unsigned char *s) {
  ...
  int64_t h7 = (int64_t)(load_3(s + 23) << 5);
  int64_t h8 = (int64_t)(load_3(s + 26) << 4);
  int64_t h9 = (int64_t)(load_3(s + 29) << 2);
  int64_t carry0;
  int64_t carry1;
  int64_t carry2;
  int64_t carry3;
...
int sc_check(const unsigned char *s) {
  ...
  int64_t s1 = (int64_t)(load_4(s + 4));
  int64_t s2 = (int64_t)(load_4(s + 8));
  int64_t s3 = (int64_t)(load_4(s + 12));
  int64_t s4 = (int64_t)(load_4(s + 16));
  int64_t s5 = (int64_t)(load_4(s + 20));
  int64_t s6 = (int64_t)(load_4(s + 24));
  int64_t s7 = (int64_t)(load_4(s + 28));
