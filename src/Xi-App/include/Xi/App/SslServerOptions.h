...
class SslServerOptions : public IOptions {
 public:
  SslServerOptions(const SslOptions& base);
 ...
 public:
  ...
  KV_MEMBER_RENAME(privateKey(), private_key)
  KV_MEMBER_RENAME(diffieHellman(), diffie_hellman)
