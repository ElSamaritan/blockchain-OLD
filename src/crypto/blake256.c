...
// datalen = number of bits
void blake224_update(state *S, const uint8_t *data, uint64_t datalen) { blake256_update(S, data, datalen); }
...
void blake224_final(state *S, uint8_t *digest) { blake256_final_h(S, digest, 0x80, 0x00); }
