...
struct Hash_v0 {
  ...
  static constexpr uint32_t windowSize() { return 32; }

  static constexpr uint32_t minRandomizerSize() { return 1 << 4; }
  static constexpr uint32_t maxRandomizerSize() { return 1 << 12; }
  static constexpr uint32_t slopeRandomizerSize() { return (maxRandomizerSize() - minRandomizerSize()) / windowSize(); }

  static constexpr uint32_t minScratchpadSize() { return 2 * 256 * 1024; }
  static constexpr uint32_t maxScratchpadSize() { return 4 * 256 * 1024; }
