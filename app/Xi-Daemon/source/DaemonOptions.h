...
class DaemonOptions : public Xi::App::IOptions {
 public:
  XI_PROPERTY(bool, printGenesis, false)
  XI_PROPERTY(std::vector<std::string>, rewardTargets, {})
  XI_PROPERTY(bool, noneInteractive, false)
