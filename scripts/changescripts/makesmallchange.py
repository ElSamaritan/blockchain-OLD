...
Open the wallets with xi-pgserivce like so:

./xi-pgservice -w Wallet1.wallet -p walletpass1 --rpc-password test --bind-port 31018
...
moveDecimal = 10000  # Xi has 2 decimals so 100 is the divide/multiply factor
