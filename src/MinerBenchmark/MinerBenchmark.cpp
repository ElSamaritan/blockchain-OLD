...
using format_hander = std::function<std::string(const CLIMinerBenchmark::BencharkSummary& summary)>;

std::string format_json(const CLIMinerBenchmark::BencharkSummary& summary) {
...
std::string format_table(const CLIMinerBenchmark::BencharkSummary& summary) {
...
std::string format_csv(const CLIMinerBenchmark::BencharkSummary& summary) {
  using namespace CommonCLI;
  std::stringstream builder;
  builder.setf(std::ios::fixed);
  builder.precision(3);
...
std::string format_discord(const CLIMinerBenchmark::BencharkSummary& summary) {
  std::stringstream builder{};
