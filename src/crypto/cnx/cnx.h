...
struct Hash_v0 {
  ...
  static constexpr uint32_t minRandomizerSize() { return 1 << 8; }
  ...
  static constexpr uint32_t minScratchpadSize() { return 32 * 1024; }
  static constexpr uint32_t maxScratchpadSize() { return 128 * 1024; }
